...
protected:
    ...
    //! add an array structure to store A products (referred to as B in original script)?
    Array1D<ACEComplex> B = Array1D<ACEComplex>("B"); 
...
public:
    ...
    //! added array for ALL Bs
    Array1D<DOUBLE_TYPE>  B_all = Array1D<DOUBLE_TYPE>("B_all"); 
